...
def main():
    ...
    parser.add_argument('--spec_attribute', default='ID', type=str, help='Special attribute')
    parser.add_argument('--save_input_files', action='store_true', help='Flag to save input files')
    ...
    Exonize(gff_file_path=gff_file_path,
            genome_path=genome_path,
            specie_identifier=specie_identifier,
            ...
            cds_overlapping_threshold=cds_overlapping_threshold,
            masking_perc_threshold=masking_perc_threshold,
