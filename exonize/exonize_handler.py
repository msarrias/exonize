...
Exonize results database:   {self.results_database_path.name}
    ...
    def output_csv(self, prefix):
        '''
        Summarize the analysis in a CSV file.
        '''
        header_items = [
            'FragmentID',          # Is this generated by exonize?
            'GeneID',
            'TranscriptID',
            'TranscriptStart',
            'TranscriptEnd',
            'QueryExonId',          # Is this is a fair description?
            'QueryExonFrame',       # Is this is a fair description?
            'QueryExonStart',       # Is this is a fair description?
            'QueryExonEnd',         # Is this is a fair description?
            'QueryMatchStart',      # These two lines are the coordinates within the queried exon, right?
            'QueryMatchEnd',
            'TargetExonID',        # What if the target is not a known exon?
            'TargetExonFrame',
            'TargetExonStart',
            'TargetExonEnd',
            'TargetMatchStart',
