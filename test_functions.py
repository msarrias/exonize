...
def test_gget_annotations_across_transcripts():
...
def test_get_coords_with_coding_exons():
    ...
    for ce in ['exon', 'coding_exon']:
        ...
        my_res_1_1 = eds_obj.get_coords_with_coding_exons(test_1_1)
        assert test_1_1_res == my_res_1_1
        test_1_2 = {P.open(1,200): {'type': 'CDS'}, P.open(1,300): {'type': ce}}
        test_1_2_res = {P.open(1,200): {'type': 'coding_exon'}, P.open(201,300): {'type': ce}}
        my_res_1_2 = eds_obj.get_coords_with_coding_exons(test_1_2)
        ...
        my_res_3_1 = eds_obj.get_coords_with_coding_exons(test_3_1)
        assert test_3_1_res == my_res_3_1
        test_3_2 = {P.open(1,200): {'type': 'CDS'}, P.open(2,300): {'type': ce}}
        test_3_2_res = {P.open(1,200): {'type': 'coding_exon'}, P.open(201,300): {'type': ce}}
        ...
        test_1_5_res = {P.open(1,199): {'type': ce},
                        P.open(200,300): {'type': 'coding_exon'}, P.open(301,400): {'type': 'CDS'}}
        my_res_1_5 = eds_obj.get_coords_with_coding_exons(test_1_5)
        assert test_1_5_res == my_res_1_5
        test_1_6 = {P.open(1,300): {'type': 'CDS'}, P.open(200,400): {'type': ce}}
        test_1_6_res = {P.open(1,199): {'type': 'CDS'},
                        P.open(200,300): {'type': 'coding_exon'}, P.open(301,400): {'type': ce}}
        my_res_1_6 = eds_obj.get_coords_with_coding_exons(test_1_6)
    ...
    for coding_region in ['exon', 'coding_exon', 'CDS']:
        for utr_intron in ['intron'] + new_Pn_genome.UTR_features:
            ...
            my_res_2_1 = eds_obj.get_coords_with_coding_exons(test_2_1)
            ...
            my_res_2_2 = eds_obj.get_coords_with_coding_exons(test_2_2)
            ...
            my_res_3_8 = eds_obj.get_coords_with_coding_exons(test_3_8)
            ...
            my_res_3_9 = eds_obj.get_coords_with_coding_exons(test_3_9)
            ...
            my_res_2_3 = eds_obj.get_coords_with_coding_exons(test_2_3)
            ...
            my_res_2_4 = eds_obj.get_coords_with_coding_exons(test_2_4)
            ...
            my_res_3_10 = eds_obj.get_coords_with_coding_exons(test_3_10)
            ...
            my_res_3_11 = eds_obj.get_coords_with_coding_exons(test_3_11)
            ...
            my_res_2_5 = eds_obj.get_coords_with_coding_exons(test_2_5)
            ...
            my_res_2_6 = eds_obj.get_coords_with_coding_exons(test_2_6)
            ...
            my_res_3_12 = eds_obj.get_coords_with_coding_exons(test_3_12)
